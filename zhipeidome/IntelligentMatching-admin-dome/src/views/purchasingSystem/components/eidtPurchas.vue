<template>
	<div>
		...
		<div class="bottomBtn">
			总金额 ：13700 	
			<el-button type="primary" @click="shows()">通过</el-button>
			<el-button type="primary" @click="shows()">驳回</el-button>
		</div>
		<!--<<备注-->
		<el-dialog :visible.sync="wareShow" title="备注" width="450px">
			...
			<span slot="footer">
				<el-button @click="submissionRemark()"> 取 消 </el-button>
				<el-button type="primary" @click="submissionRemark()"> 提交 </el-button>
			</span>
		</el-dialog>
		<!--备注>>-->
	</div>
