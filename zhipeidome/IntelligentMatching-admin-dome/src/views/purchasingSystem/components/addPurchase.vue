<template>
	<div>
				...
				<el-row>
					...
					<el-col :span="6">
						<el-form-item label="供应商:" prop="bra_name3">
							<el-input v-model="formList.bra_name3" placeholder="请输入供货商编号或简称识别" max="10" :maxlength="10" clearable class="mainIptSelBox" /><span style="color: red;">	*</span>
						</el-form-item>
					</el-col>
					<el-col :span="6">
					...
					<el-col :span="6">
						<el-form-item label="联系人" class="sd-form-item" prop="bra_name9">
							<el-input v-model="formList.bra_name9" placeholder="请输入联系人" max="10" :maxlength="10" clearable class="mainIptSelBox" /><span style="color: red;">	*</span>
						</el-form-item>
					</el-col>
					<el-col :span="6">
					...
					<el-col :span="6">
						<el-form-item label="备注" class="sd-form-item" prop="bra_name11">
							<el-input v-model="formList.bra_name11" placeholder="请输入备注码" max="10" :maxlength="10" clearable class="mainIptSelBox" />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
		...
		<div class="bottomBtn">
			...
			<el-button type="primary" @click="addBrandBtn()">提交计划</el-button>
			<el-button type="primary" @click="addBrandBtn()">提交采购</el-button>
		</div>
	</div>
</template>
<script>
