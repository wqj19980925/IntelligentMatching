	...
	<div>
				...
				<el-row>
					...
					<el-col :span="6">
						<el-form-item label="分销商:" prop="bra_name3">
							<el-input v-model="formList.bra_name3" placeholder="请输入分销商编号或简称识别" max="10" :maxlength="10" clearable class="mainIptSelBox" />
						</el-form-item>
					</el-col>
					<el-col :span="6">
		...
		<el-row class="mainContentItemBox">
			...
			<el-table :data="tableData" style="width: 100%">
				...
				<el-table-column label="分销数量" prop="numbers8" />
