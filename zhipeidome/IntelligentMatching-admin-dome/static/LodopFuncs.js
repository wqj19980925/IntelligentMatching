...
export function needCLodop(){
    try{
        ...
        return true;//强制返回 true；CLodop云打印服务器
    ...
    try{
        ...
        if (needCLodop()) {
	    	...
	    	if (!LODOP && document.readyState!=="complete") {
	    		alert("C-Lodop没准备好，请稍后再试！"); return;
	    	};
            if (!LODOP) {
            ...
            needCLodop();// 强制返回 true；不会走此非CLodop云打印服务器
		...
		LODOP.SET_LICENSES("","10980CA98AC3D6F0FC850D811EFF384B","C94CEE276DB2187AE6B65D56B3FC2848","");
        //===========================================================
        return LODOP;
