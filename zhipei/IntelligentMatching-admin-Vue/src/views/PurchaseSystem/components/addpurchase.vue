    ...
    <div>
		...
		<el-row class="mainContentItemBox">
			<div class="mainHeaderTitleBox">
                ...
                <div class="buttonBox">
					<!-- <el-button plain type="primary" @click="">返回</el-button> -->
				</div>
			</div>
			...
			<el-table :data="tableData" style="width: 100%" class="tabelDatas">
				...
				<el-table-column label="商品编码" width="200" prop="general_version" />
				<el-table-column label="商品名称" width="300" prop="goods_name" /> -->
				...
				<el-table-column label="单位" prop="company_unit" min-width="60"/>
				...
				<el-table-column min-width="130" label="税率">
					<template slot-scope="scope">
				...
				<el-table-column min-width="130" label="币种">
					<template slot-scope="scope">
				...
				<el-table-column min-width="200px" label="预计到货时间">
					<template slot-scope="scope">
...
<script>
import {PurchasePlan_turnPurchase, PurchaseOrder_AddEntry} from '@/api/PurchaseSystem'
