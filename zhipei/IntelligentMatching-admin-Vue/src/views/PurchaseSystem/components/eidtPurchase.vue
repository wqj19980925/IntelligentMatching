    ...
    <div>
		...
		<el-row class="mainContentItemBox">
			<div class="mainHeaderTitleBox">
				<div class="titleNameBox">{{editType == 1? '采购编辑':'二次编辑' }}</div>
				<div class="buttonBox">
                    ...
                    <el-row>
                        <el-col :span="6">
                            <el-form-item label="订单日期" class="sd-form-item" prop="cg_purchasetime">
                                <el-date-picker v-model="formList.cg_purchasetime" :disabled="editType != 1" align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions" class="mainIptSelBox"></el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="采购单号:" prop="cg_number">
                                <el-input  v-model="formList.cg_number" disabled placeholder="请输入采购单号" max="10" :maxlength="10" clearable class="mainIptSelBox" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="业务类型:" prop="business_type">
                                <el-select v-model="formList.business_type" :disabled="editType != 1" class="mainIptSelBox">
                        ...
                        <el-col :span="6">
                            <el-form-item label="票据类型:" prop="cg_invoicetype">
                                <el-select v-model="formList.cg_invoicetype" :disabled="editType != 1" class="mainIptSelBox">
                        ...
                        <el-col :span="6">
                            <el-form-item label="结算方式:" prop="cg_paymentype">
                                <el-select v-model="formList.cg_paymentype" :disabled="editType != 1" class="mainIptSelBox">
                        ...
                        <el-col :span="6">
                            <el-form-item label="交货方式:" prop="cg_delivertype">
                                <el-select v-model="formList.cg_delivertype" :disabled="editType != 1" class="mainIptSelBox">
                        ...
                        <el-col :span="6">
                            <el-form-item label="仓库:" class="sd-form-item" prop="cg_wareid">
                                <el-select v-model="formList.cg_wareid" :disabled="editType != 1" class="mainIptSelBox">
                        ...
                        <el-col :span="6">
                            <el-form-item label="合同号:" class="sd-form-item" prop="contract_number">
                                <el-input v-model="formList.contract_number" :disabled="editType != 1" placeholder="请输入合同号"  clearable class="mainIptSelBox" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="联系人:" class="sd-form-item" prop="contact_name">
                                <el-input v-model="formList.contact_name" :disabled="editType != 1" placeholder="请输入联系人" max="10" :maxlength="10" clearable class="mainIptSelBox" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="联系方式:" class="sd-form-item" prop="contact_phone">
                                <el-input v-model="formList.contact_phone" :disabled="editType != 1" placeholder="请输入联系方式" max="11" :maxlength="11" clearable class="mainIptSelBox" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="6">
                            <el-form-item label="部门:" class="sd-form-item" prop="group_id">
                                <el-select v-model="formList.group_id" :disabled="editType != 1" class="mainIptSelBox">
                ...
                <el-card shadow="never" class="box-card mainCardBorNoneBox">
                    ...
                    <el-table :data="tableData" style="width: 100%">
                        ...
                        <el-table-column label="数量" align="center" min-width="130">
                            <template slot-scope="scope">
                                <el-input v-model="scope.row.goods_num" v-if="editListType" placeholder="数量" @blur="/[^\d]/g.test(scope.row.goods_num) ? scope.row.goods_num = 0:'' " clearable class="mainIptSelBox" />
                                <p v-else>
                                    {{scope.row.goods_num}}
                                </p>
                            </template>
                        ...
                        <el-table-column label="单价" align="center" min-width="130">
                            <template slot-scope="scope">
                                <el-input v-model="scope.row.univalence" v-if="editListType" placeholder="单价"  @blur="!/(^[1-9]\d*(\.\d{1,2})?$)|(^0(\.\d)?$)/.test(scope.row.univalence) ? scope.row.univalence = 0 :''" clearable class="mainIptSelBox" />
                                <p v-else>
                                    {{scope.row.univalence}}
                                </p>
                            </template>
                        </el-table-column>
                        <el-table-column width="100" align="center" label="税率">
                            <template slot-scope="scope">
                                <el-select v-model="scope.row.tax_rate" v-if="editListType" class="mainIptSelBox" @change="bumens">
                        ...
                        <el-table-column min-width="100"  align="center" label="币种">
                            <template slot-scope="scope">
                                <el-select v-model="scope.row.currency" v-if="editListType"  class="mainIptSelBox">
                        ...
                        <el-table-column label="金额" prop="money" align="center" min-width="80"/>
                        <el-table-column width="150" align="center"  label="预计到货时间">
                            <template slot-scope="scope">
                                <el-date-picker v-if="editListType" v-model="scope.row.estimate_time" value-format="yyyy-MM-dd" align="right" type="date" placeholder="选择日期" :picker-options="pickerOptions">
                                </el-date-picker>
                        ...
                        <el-table-column label="操作" fixed="right" min-width="120" align="center">
                            <template slot-scope="scope">
                                <el-button size="mini"  v-if="editListType" @click="deltaiFun(scope.$index)" class="btn-delete">撤销</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-card>
...
<script>
import {PurchaseOrder_EditEntry,PurchaseOrder_ForceEdit} from '@/api/PurchaseSystem'
    ...
    methods:{
        ...
        getinforData(){
            ...
            if(this.editType == 1){
                ...
                PurchaseOrder_ForceEdit(datadd).then(success=>{
                    loading.close();
                    if(success.data.code == 200){
                        this.formList = success.data.data.cg_data;
                        this.tableData = success.data.data.storage_goods;
