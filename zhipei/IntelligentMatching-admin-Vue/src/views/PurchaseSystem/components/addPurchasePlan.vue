    ...
    <div>
		...
		<el-row class="mainContentItemBox">
			<div class="mainHeaderTitleBox">
				<div class="titleNameBox">新增计划</div>
				<div class="buttonBox">
			...
			<el-form ref="formList" :model="formList" size="medium" :rules="formRules" label-width="100px" class="mainSearchItemBox">
				...
				<el-card shadow="never" class="box-card mainCardBorNoneBox">
                    ...
                    <el-row>
                        <el-col :span="6">
                            <el-form-item label="计划日期" class="sd-form-item" prop="cg_purchasetime" required >
...
<script>
import { PurchasePlan_AddPurchPlan} from '@/api/PurchaseSystem'
...
export default {
    ...
    methods:{
        ...
        getinforData(){
            ...
            let datadd = {};
            datadd.type = 1;
            PurchasePlan_AddPurchPlan(datadd).then(success=>{
                loading.close();
